...
Text::Text()
{
	...
	textShader = SceneGraph::createShaderProgram(namebuf, 0, "Text.vs", "Text.fs", 0);
	...
	)
{
	...
	textShader->setTexture("fonttex", fontTexture);
	...
	)
{
	...
	u8 aCol0 = (u8) (((f32) color[3]) * alphaMultiplier + 0.5f);
	u8 aCol1 = (u8) (((f32) color[7]) * alphaMultiplier + 0.5f);
