...
ResourceViewer	*DefaultObjects::rview;
...
void DefaultObjects::init()
{
	...
	failureShaderProgram = SceneGraph::createShaderProgram("FailureShaderProgram", 0, "Default.vs", "Default.fs", 0);
	...
	bulbShader = SceneGraph::createShaderProgram("LightShader", 0, "Light.vs", "Light.fs", 0);
	...
	camShader = SceneGraph::createShaderProgram("CameraShader", 0, "Camera.vs", "Camera.fs", 0);
	...
	arrowShader = SceneGraph::createShaderProgram("ArrowShader", 0, "Axis.vs", "Axis.fs", 0);
	...
	*/
	axis[0]->setValue("col", red);
	axis[1]->setValue("col", green);
	axis[2]->setValue("col", blue);
	...
	/* Grid */
	{
		...
		gridShader = SceneGraph::createShaderProgram("GridShader", 0, "Grid.vs", "Grid.fs", 0);
		...
		gridShader->setValue("Color", color);
		gridShader->renderState.disableCulling();

	}

	rview = new ResourceViewer();
